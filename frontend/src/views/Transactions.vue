<template>
  <div>
    <div class="flex justify-between items-center mb-6">
      ...
      <button @click="showAddModal = true" class="bg-primary hover:bg-blue-600 text-white font-bold py-2.5 px-5 rounded-lg transition-all shadow-sm hover:shadow-md flex items-center gap-2">
